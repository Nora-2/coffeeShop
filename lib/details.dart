                    ...
                    children: [
                      ...
                      Expanded(
                        ...
                        children: [
                          ...
                          GestureDetector(
                            onTap: () {
                              Navigator.pushNamedAndRemoveUntil(context, paymentScreen.id, (r) => false);
                            ...
                            child: Container(
                              ...
                              width: 250,
                              decoration: BoxDecoration(
                                gradient: const LinearGradient(colors: [Color(0xffCB8A58),Color(0xff562B1A),Color(0xffCB8A58),]),
                                  color: Colors.brown,
