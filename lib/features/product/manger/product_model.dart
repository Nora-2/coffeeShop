...
class Product implements Comparable<Product>{
  ...
  int get hashCode => Object.hash(id, name, desc, createdAt, modifyAt, images,
      colors, sku, price, isFavorite, totalQuantity);

  @override
  String toString() {
    return 'Product{id: $id, name: $name, desc: $desc, createdAt: $createdAt, modifyAt: $modifyAt, images: $images, colors: $colors, sku: $sku,  price: $price,  isFavorite: $isFavorite, totalQuantity: $totalQuantity}';
  }
